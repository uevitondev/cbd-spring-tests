...
public class ReviewResourceIT {
    ...
    public void insertShouldReturnUnauthorizedWhenNotValidToken() throws Exception {
        ...
        ResultActions result = mockMvc.perform(post("/reviews").content(jsonBody).contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON));
    ...
    public void insertShouldReturnForbiddenWhenVisitorAuthenticated() throws Exception {
        ...
        ResultActions result = mockMvc.perform(post("/reviews").header("Authorization", "Bearer " + accessToken).content(jsonBody).contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON));
